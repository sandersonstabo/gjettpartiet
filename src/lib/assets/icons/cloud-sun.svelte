    ...
    >
        <g fill="none" class="nc-icon-wrapper">
            <path
                ...
                fill="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_0_0q0lmiqhr)"
                data-glass="origin"
                mask="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_mask_jhfwmn5x5)"
            ></path>
            <path
                d="M11 9C11 5.68629 13.6863 3 17 3C20.3137 3 23 5.68629 23 9C23 12.3137 20.3137 15 17 15C13.6863 15 11 12.3137 11 9Z"
                fill="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_0_0q0lmiqhr)"
                data-glass="clone"
                filter="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_filter_teh5we5le)"
                clip-path="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_clipPath_u03c5vwer)"
            ></path>
            <path
                ...
                fill="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_1_dzu62c2d8)"
                data-glass="blur"
            ></path>
            <path
                ...
                fill="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_2_sfqay8ihr)"
            ></path>
            <defs>
                <linearGradient
                    id="fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_0_0q0lmiqhr"
                    x1="17"
                    y1="3"
                    x2="17"
                    y2="15"
                ...
                <linearGradient
                    id="fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_1_dzu62c2d8"
                    x1="11.5"
                    y1="4"
                    x2="11.5"
                    y2="21"
                ...
                <linearGradient
                    id="fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_2_sfqay8ihr"
                    x1="11.5"
                    y1="4"
                    x2="11.5"
                    y2="13.845"
                ...
                <filter
                    id="fa71x1fnbmc-1775570030288-2789853_cloud-sun_filter_teh5we5le"
                    x="-100%"
                    y="-100%"
                    width="400%"
                    height="400%"
                ...
                <clipPath
                    id="fa71x1fnbmc-1775570030288-2789853_cloud-sun_clipPath_u03c5vwer"
                >
                    <path
                        d="M17.8789 11.0781C17.2021 7.06081 13.7098 4 9.5 4C4.80558 4 1 7.80558 1 12.5C1 17.1944 4.80558 21 9.5 21H17C19.7614 21 22 18.7614 22 16C22 13.5385 20.2211 11.4936 17.8789 11.0781Z"
                        fill="url(#fa71x1fnbmc-1775570030288-2789853_cloud-sun_existing_1_dzu62c2d8)"
                ...
                <mask
                    id="fa71x1fnbmc-1775570030288-2789853_cloud-sun_mask_jhfwmn5x5"
                >
